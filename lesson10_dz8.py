...
def convert_uppercase_strlist(str_list):
    ...
    return result
    # return [conv_str.upper() for conv_str in str_list]


def get_int_range_list(upper_bound):
    range_list = [number for number in range(1, upper_bound + 1)]
    return range_list


def get_square_range_list(upper_bound):
    range_list = [number ** 2 for number in range(1, upper_bound + 1)]
    return range_list
